						...
						<div class="advanced_search_filter_panel">
							...
							<div class="col-md-6 col-sm-12 none-left-padding none-right-padding">
								...
								<div class="inlined">
									...
									<div class="col-md-4 col-sm-4 pad-left pad-right pad-5">
      ...
      module.exports = {
        ...
        data: function(){
            return {
                ...
                web_options: [
                	{ id: 'web', text: 'web' },
                    { id: 'Select_hours', text: 'Select hours' },
        ...
        methods: {
            ...
            fetchReport: function(start_time, end_time, step, filterURL, field_ind = 0, method = 'total') {
                ...
                console.log("api url: ", api.getReport_URL());
                console.log("active index: ", this.active_tab_index);
                console.log("token: ", auth.getCdrToken());
            ...
            searchReport: function(type){
                ...
                console.log("start_time: ", start_time);
                console.log("end_time: ", end_time);
                console.log("by_hours: ", this.by_hours);
