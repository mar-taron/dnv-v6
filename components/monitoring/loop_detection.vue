                    ...
                    <tab label="Define Looping Rule" class="" icon="dnl_icon dnl_setting" selected>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover aliases">
                                <thead>
                                    <tr>
                                        <th  @click="sortColumn('rule_name')" v-if="showcolumns[0]">
                                            Rule Name
                                            <a @click="sortColumn('rule_name')">
                                                <span class="dnl_icon dnl_sort pull-right"></span>
                                            </a>
                                        </th>
                                        <th v-if="showcolumns[1]"  @click="sortColumn('counter_time')" >
                                            Counter Time (s)
                                            <span class="dnl_icon dnl_sort pull-right"></span>

                                        </th>
                                        <th  v-if="showcolumns[2]" v-on:click="sortColumn('name')">
                                             Number
                                            <span class="dnl_icon dnl_sort pull-right"></span>

                                        </th>
                                        <th @click="sortColumn('block_time')" v-if="showcolumns[3]">
                                             Block Time (s)
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                         </th>
...
module.exports = {
    ...
    methods: {
        ...
        sortColumn(column) {console.log('sortinggg');
        ...
        fetchLoops() {
            ...
            this.$http.get(api.getEndpointUrl() + this.apiUrl + "?page=" + page + "&per_page=" + per_page + "&order_by=" + this.order + "&order_dir=" + this.nameSort,
                {
                    headers: {
