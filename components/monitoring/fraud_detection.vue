                            ...
                            <table class="table table-striped table-hover aliases">
                                <thead>
                                    <tr>
                                        ...
                                        <th v-if="showcolumns[1]" @click="sortColumn('one_hour_duration')">1 Hour Minute
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[2]" @click="sortColumn('one_hour_revenue')">1 Hour Revenue
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[3]" @click="sortColumn('hour_24_duration')">24 Hours Minute
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[4]" @click="sortColumn('hour_24_revenue')">24 Hours Revenue
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[5]" @click="sortColumn('enable_block')">Block
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[6]" @click="sortColumn('enable_email')">Send Email
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[7]" @click="sortColumn('active')">Active
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[8]" @click="sortColumn('update_on')">Last Update
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
                                        <th v-if="showcolumns[9]" @click="sortColumn('update_by')">Updated by
                                            <span class="dnl_icon dnl_sort pull-right"></span>
                                        </th>
...
module.exports = {
    ...
    data: function () {
        return {
			...
			fraud_table_columns: ['Rule Name', '1 Hour Minute', '1 Hour Revenue',
                ...
                'Active', 'Last Update', 'Updated by', 'Action'],
    ...
    methods: {
		...
		handleChange() {
			...
			if (_.indexOf(this.fraud_table_columns, 'Updated by') != -1) {
...
#app > div.container-fluid > div > div > div.tabs > div.tabs_container > div:nth-child(1) > div.table-responsive > table > thead > tr > th:nth-child(1) > span{
