						...
						<form class="form" @submit.prevent="validateBeforeSubmit">
							...
							<section class="role_section basic_section m-left-0">
								...
								<div class="form-group">
									...
									<div class="position_relative">
										<input type="text" name="occurance" class="form-control small" :class="{'input': true, 'is-danger': errors.has('occurance') }" v-model="data.occurance" v-validate="'required|numeric'">
										<span v-show="errors.has('occurance')" class="danger right-notification">{{ errors.first('occurance') }}</span>
									</div>
									times within
									<div class="position_relative">
										<input type="text" name="period" class="form-control small" :class="{'input': true, 'is-danger': errors.has('period') }" v-model="data.period" v-validate="'required|numeric'">
							...
							<section class="role_section basic_section m-left-0">
								...
								<div class="form-group">
									...
									Block this ANI and DNIS combination for
									<div class="position_relative">
										<input type="text" name="block_second" class="form-control small" :class="{'input': true, 'is-danger': errors.has('block_second') }" v-model="data.block_second" v-validate="'required|numeric'">
