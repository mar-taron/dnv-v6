			...
			<div class="white_pad table_wrap">
				...
				<div class="table-responsive">
					<table class="table table-striped table-hover aliases">
					  <thead>
							<tr>
								<th v-if="showcolumns[0]">DID   <a @click="sortColumn('did')">
...
<script>   
	...
	module.exports = {
		...
		data: function(){
			return {
				showcolumns: [true, false, true, true, true, true],
                nameSort: 'asc',
                sort: '',
                order: '',
				routing_table_columns: ['DID', 'Vendor Trunk', 'Client Trunk', 'Updated At', 'Updated By', 'Actions'],
				temp_routing_table_columns: ['DID', 'Vendor Trunk', 'Client Trunk', 'Updated At', 'Updated By', 'Actions'],
