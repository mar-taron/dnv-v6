					...
					<table class="table table-striped table-hover aliases credits">
					  <thead>
						<tr>
						  ...
						  <th v-if="showcolumns[1]" @click="sortColumn('type')">Type Rate
							  <span class="dnl_icon dnl_sort pull-right"></span>
						  </th>
						  <th v-if="showcolumns[2]" @click="sortColumn('monthly_fee')">Price/DID/Month
							  <span class="dnl_icon dnl_sort pull-right"></span>
						  </th>
						  <th v-if="showcolumns[3]" @click="sortColumn('rate_per_min')">Price/Minute
							  <span class="dnl_icon dnl_sort pull-right"></span>
						  </th>
						  <th v-if="showcolumns[4]" @click="sortColumn('payphone_subcharge')">Payphone Subcharge
							  <span class="dnl_icon dnl_sort pull-right"></span>
						  </th>
						  <th v-if="showcolumns[5]" @click="sortColumn('setup_fee')">Setup Fee
							  <span class="dnl_icon dnl_sort pull-right"></span>
						  </th>
