						...
						<section class="config_section">
							...
							<div class="row">
									...
									<template v-for="(item, index) in resource.ip">
										...
										<div class="col-md-2 col-sm-2" v-if="index==0">
										...
										<div class="col-md-4 col-sm-6">
											<div class="form-group">
												...
												<select class="selectable" v-model="resource.t38">
...
<script>   
	...
	module.exports = {
		...
		methods: {
			...
			getClientForRequest() {
				const client_template = JSON.parse( JSON.stringify( this.client_template ) )
