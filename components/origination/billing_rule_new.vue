					...
					<!--<div class="col-md-8 col-sm-10">-->
						<form class="form">
							...
							<div class="button_set little-space">
								<a class="btn btn-primary mini" @click="validateForRule">
									Submit
								</a>
								<a class="btn btn-default mini" @click="resetRule">
									Reset
								</a>
							</div>
						</form>
...
module.exports = {
	...
	methods: {
		...
		getRuleForRequest() {
			const rule_template = JSON.parse( JSON.stringify( this.rule_template ) )
