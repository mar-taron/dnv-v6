					...
					<form class="form">
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_name" v-model="vendor.vendor_name" class="form-control" :class="{'input': true, 'is-danger': errors.has('vendor_name') }" v-validate="'required'" placeholder="Enter Vendor Name">
                                <span v-show="errors.has('vendor_name')" class="help is-danger">{{ errors.first('vendor_name') }}</span>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                        ...
                        <template v-for="(item, index) in resource.ip">
                         <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ip" v-model="item.ip" class="form-control" :class="{'input': true, 'is-danger': errors.has('ip') }" v-validate="'required'" placeholder="Enter IP">
                        ...
                        <div class="col-md-2 col-sm-2">
                            <div class="form-group">
                                <label>Port:</label>
                                <input type="text" name="port" v-model="item.port" class="form-control" :class="{'input': true, 'is-danger': errors.has('port') }" v-validate="'required|numeric'" placeholder="Enter Port">
                                <span v-show="errors.has('port')" class="help is-danger">{{ errors.first('port') }}</span>
                            </div>
                        </div>
...
<script>   
	...
	module.exports = {
		...
		methods: {
            ...
            getVendorForRequest () {
                const vendor_template = JSON.parse( JSON.stringify( this.vendor_template ) )
