						...
						<table class="table table-striped table-hover agents ">
						  <thead>
							<tr>
                              ...
                              <th v-if="showcolumns[6]">Updated at</th>
							  <th v-if="showcolumns[7]">Updated by</th>
	...
	module.exports = {
		...
		methods: {
			...
			handleChange() {
				...
				if (_.indexOf(this.rate_table_columns, 'Updated at') != -1) {
				...
				if (_.indexOf(this.rate_table_columns, 'Updated by') != -1) {
