	...
	<div class="payment-container container-fluid">
		<div class="row">
			<div class="wrapper single">
				...
				<div class="timeline">
					<div v-if="date-filters" class="chart_select_header grided">
					...
					<div class="chart_content">
						<div class="side-margin-40">
						<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12 payment-search">
               			...
               			<div class="col-md-6 col-sm-6 col-xs-12 pagerow-top pad-0 clear-right-padding">
						<div class="float-r inline-block">
							<span class="inline-block">Page row:</span>
							<select2 :options="page_rows" v-model="page_row_count" class="inline-block" @pagecount="changePageCount">
							</select2>
						</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12 m-top-20 clear-right-padding m-top-0 pad-0">
						...
						<div class="col-md-12">
							<div class="table-responsive marged-30">
								<table class="table table-striped table-hover carrier_groups originators">
									<thead>
										<tr>
											<th class="text-l" v-if="showcolumns[0]">
												Payment Date
												<a @click="sortColumn('date')"><span class="dnl_icon dnl_sort pull-right"></span></a>

											</th>
											<th class="text-l" v-if="showcolumns[1]">
										<a @click="sortColumn('date')"><span class="dnl_icon dnl_sort pull-right"></span></a>
												Reference</th>
											<th class="text-l" v-if="showcolumns[2]">
										<a @click="sortColumn('date')"><span class="dnl_icon dnl_sort pull-right"></span></a>

												Charges</th>
											<th class="text-l" v-if="showcolumns[3]">
										<a @click="sortColumn('date')"><span class="dnl_icon dnl_sort pull-right"></span></a>
												Amount</th>
											<th class="text-l" v-if="showcolumns[1]">
										<a @click="sortColumn('date')"><span class="dnl_icon dnl_sort pull-right"></span></a>
...
#app > div.payment-container.container-fluid > div > div, 
#app > div.payment-container.container-fluid{
	background: #f7f8f9!important;
}
.text-l{
	text-align: left!important;
}
#app > div.payment-container.container-fluid > div > div > div > div.chart_content > div.table_filters.marged-40 > div > div:nth-child(1) > div > input{
...
.mar-top {
	...
	@media (min-width: 954px){
		#app > div.payment-container.container-fluid > div > div > div > div.chart_content > div.table_filters.marged-40 > div > div.col-md-6.col-sm-6.col-xs-12.bottom.mar-top{
	...
	@media (max-width:767px) {
		...
		#app > div.payment-container.container-fluid > div > div > div > div.chart_content > div.table_filters.marged-40 > div > div:nth-child(1){
			margin-bottom: 15px;
		}
		.el-select{
			margin-top: 15px;
