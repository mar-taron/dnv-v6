<template>
	<div style="margin-top: 140px!important;" class="container-fluid">
		<div class="row">
			<div class="wrapper single">
				...
				<div class="timeline">
					<div class="chart_select_header grided">
						...
						<div class="col-lg-1 col-md-1 col-sm-3 pad-left pad-right pad-5">
					...
					<div class="chart_content">
                        ...
                        <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="entries-select inline-block">
                            <a class="btn btn-primary m-top-25">
                                Export
                            </a>
                        </div>
						...
						<div class="table_filters marged-40">
							...
							<div class="inline-block" style="margin-left: 0px;">
						...
						<div class="col-md-12">
							<div class="table-responsive marged-30">
								<table class="table table-striped table-hover carrier_groups aligned-center">
									...
									<tr>
										<td v-if="showcolumns[0]">Test Date</td>
										<td v-if="showcolumns[1]">Carrier Test</td>
										<td v-if="showcolumns[2]">Test Period</td>
										<td v-if="showcolumns[3]">Gross Test</td>
										<td v-if="showcolumns[4]">Paid Test</td>
										<td v-if="showcolumns[5]">Due Test</td>
										<td class="width-340">
											<a class="action action_activate" data-toggle="tooltip" data-placement="top" title="Apply Payment">
