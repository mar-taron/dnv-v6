...
module.exports = {
    ...
    data: function () {
        return {
            ...
            loading: false,
            apiUrl: '/carrier/{client_id}/transactions/list',
            search: '',
			period: '',
			trunk: '',
			gmt: '',
            ...
            // },
            reports: [
				{asr:'0%', adc:'1', pdd:'0', total_duration:'1.00', total_billable:'1.00', total_billable:'1.00'},
				{asr:'0%', adc:'2', pdd:'0', total_duration:'2.00', total_billable:'2.00', total_billable:'1.00'},
				{asr:'0%', adc:'3', pdd:'0', total_duration:'3.00', total_billable:'3.00', total_billable:'1.00'}
			],
        }
    },
    methods: {
...
table.table.table-striped.table-hover.aliases td, table.table.table-striped.table-hover.aliases th{
	text-align: left;
}
.el-select__tags {
	display: none;
