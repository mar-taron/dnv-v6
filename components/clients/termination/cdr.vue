    ...
    <div class="container-fluid">
        <div class="row">
            <div class="wrapper single">
                ...
                <h1 class="page-header">My CDR</h1>
                <div class="row">
                ...
                <tabs>
                    <tab label="Successfull Calls(Latest 500 attempts)" class="" icon="dnl_icon dnl_qos_report" selected>
                            ...
                            <div class="pull-right">
                                ...
                                <div class="inline-block fix_medium_select">
                                    <el-select v-model="cdr_table_columns" multiple placeholder="Show/Hide Columns" @change="handleChange">
                                        <el-option v-for="item in cdr_column_options" :key="item.value" :label="item.label" :value="item.value">
                                        </el-option>
                                    </el-select>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover aliases">
                                <thead>
                                <tr>
                                    <th v-if="showcolumns[0]">TG IP</th>
                                    <th v-if="showcolumns[1]">Start Time</th>
                                    <th v-if="showcolumns[2]">ANS Time</th>
                                    <th v-if="showcolumns[3]">Calling Number</th>
                                    <th v-if="showcolumns[4]">Dialed Number</th>
                                    <th v-if="showcolumns[5]">Account Type</th>
                                    <th v-if="showcolumns[6]">Account Type</th>
                                    <th v-if="showcolumns[7]">Number Type</th>
                                    <th v-if="showcolumns[8]">PDD</th>
                                    <th v-if="showcolumns[9]">Trunk Group</th>
                                    <th v-if="showcolumns[10]">Hangup Cause</th>
                                    <th v-if="showcolumns[11]">Reason</th>
                                </tr>
                                </thead>
                                <tbody>
                    ...
                    <tab label="Successfull SMS(a) (Latest 500 attempts)" class="" icon="dnl_icon dnl_export">
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-3 pull-right">
                                    <el-select v-model="cdr_log_table_columns" multiple placeholder="Show/Hide Columns" @change="handleLogChange">
    ...
    module.exports = {
        ...
        data: function () {
            return {
                ...
                cdr_table_columns: ['TG IP', 'Start Time', 'ANS Time', 'Calling Number', 'Dialed Number', 'Account Type', 'Number Type', 'PDD', 'Trunk Group', 'Hangup Cause', 'Reason'],
        ...
        methods: {
            ...
            handleLogChange() {
                if (_.indexOf(this.cdr_log_table_columns, 'Rule Name') != -1) {
                    Vue.set(this.log_showcolumns, 0, true);
                }
                else {
                    Vue.set(this.log_showcolumns, 0, false);
                }

                if (_.indexOf(this.cdr_log_table_columns, 'Start Time') != -1) {
                    Vue.set(this.log_showcolumns, 1, true);
                }
                else {
                    Vue.set(this.log_showcolumns, 1, false);
                }

                if (_.indexOf(this.cdr_log_table_columns, 'Finish Time') != -1) {
                    Vue.set(this.log_showcolumns, 2, true);
                }
                else {
                    Vue.set(this.log_showcolumns, 2, false);
                }

                if (_.indexOf(this.cdr_log_table_columns, 'Create By') != -1) {
                    Vue.set(this.log_showcolumns, 3, true);
                }
                else {
                    Vue.set(this.log_showcolumns, 3, false);
                }

                if (_.indexOf(this.cdr_log_table_columns, 'Status') != -1) {
                    Vue.set(this.log_showcolumns, 4, true);
                }
                else {
                    Vue.set(this.log_showcolumns, 4, false);
                }
            },
            handleChange() {
                if (_.indexOf(this.cdr_table_columns, 'TG IP') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Start Time') != -1) {
                    Vue.set(this.showcolumns, 1, true);
                }
                else {
                    Vue.set(this.cdr_table_columns, 1, false);
                }

                if (_.indexOf(this.cdr_table_columns, 'ANS Time') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Calling Number') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Dialed Number') != -1) {
                    Vue.set(this.showcolumns, 4, true);
                }
                else {
                    Vue.set(this.cdr_table_columns, 4, false);
                }

                if (_.indexOf(this.cdr_table_columns, 'Account Type') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Number Type') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'PDD') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Trunk Group') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Hangup Cause') != -1) {
                ...
                if (_.indexOf(this.cdr_table_columns, 'Reason') != -1) {
...
<style>
    #app > div.container-fluid > div > div > div.tabs > div.tabs_container > div:nth-child(2) > div.advanced_search_filter_panel > div.col-md-2.col-sm-4 > a {
        margin-top: 22px;
    }
    ...
    #app > div.container-fluid > div > div > div.tabs > div.tabs_container > div:nth-child(1) > div.row > div.col-md-2.col-sm-push-4 > span > span.selection > span {
        margin-top:25px;
    ...
    @media (max-width: 767px){
        #app > div.container-fluid > div > div > div.tabs > div.tabs_container > div:nth-child(2) > div.col-sm-12 > div > div.col-sm-4 > div > div:nth-child(1){
            text-align: left;
        }
        #app > div.container-fluid > div > div > div.tabs > div.tabs_container > div:nth-child(2) > div.col-sm-12 > div > div.col-sm-3.pull-right{
            margin-top: -36px;
        }
        #app > div.container-fluid > div > div > div.tabs > div.tabs_container > div:nth-child(2) > div.col-sm-12 > div{
            margin-bottom: 15px;
        }
    }
