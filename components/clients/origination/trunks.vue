		...
		<div class="row">
			<div class="wrapper single">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Trunk Groups</li>
				</ol>
				<h1 class="page-header">My Trunk Groups</h1>
				<div class="row">
					<div class="col-sm-3 col-lg-2">
						<router-link style="width:100%;" :to="'/clients/termination/trunks_settings'" class="btn btn-primary biggest">
				...
				<div class="white_pad table_wrap">
					<div class="table_filters">
						<div class="inline-block search_wrapper">
							<label>Search:</label>
							<br>
							<input type="text" name="search" placeholder="Enter Search" class="form-control inline-block search_field">
							<span class="payment_search_button dnl_icon dnl_musica-searcher"></span></div>
					...
					<div class="table-responsive">
						<table class="table table-striped table-hover carrier_groups">
							...
							<tr>
								...
								ID	<a @click="sortColumn('id')"><span class="dnl_icon dnl_sort pull-right"></span></a>
								</th>
								...
								<th v-if="showcolumns[1]">
									Primary IP/Call Forwarding
									<a @click="sortColumn('title')"><span class="dnl_icon dnl_sort pull-right"></span></a>
								</th>
								<th v-if="showcolumns[2]">
									Billing Type
									<a @click="sortColumn('type')"><span class="dnl_icon dnl_sort pull-right"></span></a>
								</th>
								<th v-if="showcolumns[3]">
									Payment
									<a @click="sortColumn('payment')"><span class="dnl_icon dnl_sort pull-right"></span></a>
								</th>
