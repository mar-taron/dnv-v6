            ...
            <div class="white_pad table_wrap">
                ...
                <div class="advanced_search_filter_panel bottom_0">
                    <div class="inline-block search_wrapper">
						...
						<span class="search-icon dnl_icon dnl_musica-searcher" @click="searchByName"></span>
                    </div>
					<div class="inline-block search_wrapper">
                ...
                <router-link to="/template/carrier_template/new" class="marg-top-btn btn btn-primary mini pull-right">
                      ...
                      <tbody>
                          <tr v-for="template in filterBy(templates, template_name)">
                              ...
                              <td v-if="showcolumns[4]">
                                  ...
                                  <a v-if="template.used_by > 0" class="blue_link" @click="items=[]; showModal='used_list'; getUsedList(template.id)">{{template.used_by}}</a>
                              </td>
	...
	module.exports = {
		...
		methods: {
			...
			getUsedList(id) {
                ...
                const url = api.getEndpointUrl() + "/v1/carrier/list?carrier_template_id=" + id;
                this.$http.get(url)
                    .then(response => {
