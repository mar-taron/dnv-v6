			...
			<tabs>
				<tab label="Origination" class="" icon="dnl_icon dnl_to_left" selected>
						...
						<div  class="col-md-6 col-sm-12 none-left-padding none-right-padding">
							<div>
								<div class="col-md-3 col-sm-4">
									<label></label>
									<div class="row">
										<div class="col-sm-3 text-center pad-5 pad-left pad-right">
											<label style="margin-top:5px">in</label>
										</div>
										<div class="col-sm-9 pad-5 pad-left pad-right">
					...
					<span class="table_time chart_time margin_0">
						Report Period 2017-09-02 17:34:52 +0000 - 2017-09-02 18:34:52 +0000
					</span>
					<div class="clearfix"></div>
					<div class="table-responsive">
						<table class="table table-striped table-hover carrier_groups centrum">
						  <thead>
							<tr>
								<th @click="sortColumn('cause')">Release Cause
									<span class="dnl_icon dnl_sort pull-right"></span>

								</th>
								<th @click="sortColumn('counts')">Counts
									<span class="dnl_icon dnl_sort pull-right"></span>
								...
								<th @click="sortColumn('response')">SIP Response
									<span class="dnl_icon dnl_sort pull-right"></span>
				...
				<tab label="Termination" class="" icon="dnl_icon dnl_to_right">
					...
					<div class="table-responsive">
						<table class="table table-striped table-hover carrier_groups centrum">
						  <thead>
							<tr>
								<th @click="sortColumn('release_cause')" >Release Cause
									<span class="dnl_icon dnl_sort pull-right"></span>
