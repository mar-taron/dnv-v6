		...
		<div class="wrapper single">
			...
			<div class="white_pad table_wrap">
				...
				<div class="table-responsive">
					<table id="carrierTable" class="table table-striped table-hover carrier_fields">
					  <thead>
						<tr>
						  <th  class="">Field Names <span class="dnl_icon dnl_sort pull-right"></span></th>
						  <th class="">
...
<style>
	...
	@media (max-width: 480px) {
		...
		#carrierTable > thead > tr > th:nth-child(1) > span {
