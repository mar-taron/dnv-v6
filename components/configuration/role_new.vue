	...
	<div class="container-fluid">
		<div class="row">
			<div class="wrapper single">
				...
				<router-link to="/configuration/roles" class="btn btn_white back">
								...
								<section class="role_section basic_section">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="role_name" v-model="role_name" class="form-control" :class="{'input': true, 'is-danger': errors.has('role_name') }" v-validate="'required'" placeholder="Enter Role Name">
							...
							<tab label="Finance Permissions" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_finance_perm" name="all_finance_perm" type="checkbox" v-model="all_finance_perm" @click="clickCkbAllFinPerm">
												<label for="all_finance_perm">All</label>
											</div>
										</div>
									</div>
									<div class="clearfix"></div>
							...
							<tab label="Configuration" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_config" name="all_config" type="checkbox" v-model="all_config" @click="clickCkbAllConf">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_config_write" name="all_config_write" type="checkbox" v-model="all_config_write" @click="clickCkbAllConfW" :disabled="!all_config">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="users_write" name="users_write" type="checkbox" v-model="users_write" :disabled="!users">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="role_write" name="role_write" type="checkbox" v-model="role_write" :disabled="!role">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="system_setting_write" name="system_setting_write" type="checkbox" v-model="system_setting_write" :disabled="!system_setting">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="invoice_setting_write" name="invoice_setting_write" type="checkbox" v-model="invoice_setting_write" :disabled="!invoice_setting">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="payment_setting_write" name="payment_setting_write" type="checkbox" v-model="payment_setting_write" :disabled="!payment_setting">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="global_route_error_write" name="global_route_error_write" type="checkbox" v-model="global_route_error_write" :disabled="!global_route_error">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="mail_sender_write" name="mail_sender_write" type="checkbox" v-model="mail_sender_write" :disabled="!mail_sender">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="system_modules_write" name="system_modules_write" type="checkbox" v-model="system_modules_write" :disabled="!system_modules">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="mail_template_write" name="mail_template_write" type="checkbox" v-model="mail_template_write" :disabled="!mail_template">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="login_page_content_write" name="login_page_content_write" type="checkbox" v-model="login_page_content_write" :disabled="!login_page_content">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="cdr_generation_format_write" name="cdr_generation_format_write" type="checkbox" v-model="cdr_generation_format_write" :disabled="!cdr_generation_format">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="carrier_group_write" name="carrier_group_write" type="checkbox" v-model="carrier_group_write" :disabled="!carrier_group">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="trunk_group_write" name="trunk_group_write" type="checkbox" v-model="trunk_group_write" :disabled="!trunk_group">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="syspris_write" name="syspris_write" type="checkbox" v-model="syspris_write" :disabled="!syspris">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="ftp_job_write" name="ftp_job_write" type="checkbox" v-model="ftp_job_write" :disabled="!ftp_job">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="fail_over_rule_write" name="fail_over_rule_write" type="checkbox" v-model="fail_over_rule_write" :disabled="!fail_over_rule">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="carrier_portal_cdr_field_write" name="carrier_portal_cdr_field_write" type="checkbox" v-model="carrier_portal_cdr_field_write" :disabled="!carrier_portal_cdr_field">
							...
							<tab label="Finance" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_finance" name="all_finance" type="checkbox" v-model="all_finance" @click="clickCkbAllFin">
									...
									<!-- <div class="col-sm-8">
											<div class="form-group">
												<div class="checkbox checkbox-success">
													<input id="all_finance" name="all_finance" type="checkbox" v-model="all_finance" @click="clickCkbAllFinW">
													<label for="all_finance">All read</label>
												</div>
											</div>
										</div> -->
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_finance_write" name="all_finance_write" type="checkbox" v-model="all_finance_write" @click="clickCkbAllFinW" :disabled="!all_finance">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="mutual_transaction_write" name="mutual_transaction_write" type="checkbox" v-model="mutual_transaction_write" :disabled="!mutual_transaction">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="past_due_notification_log_write" name="past_due_notification_log_write" type="checkbox" v-model="past_due_notification_log_write" :disabled="!past_due_notification_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="regenerate_balance_write" name="regenerate_balance_write" type="checkbox" v-model="regenerate_balance_write" :disabled="!regenerate_balance">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="past_due_summary_write" name="past_due_summary_write" type="checkbox" v-model="past_due_summary_write" :disabled="!past_due_summary">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="carrier_invoice_history_write" name="carrier_invoice_history_write" type="checkbox" v-model="carrier_invoice_history_write" :disabled="!carrier_invoice_history">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="auto_invoice_management_write" name="auto_invoice_management_write" type="checkbox" v-model="auto_invoice_management_write" :disabled="!auto_invoice_management">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="actual_transaction_write" name="actual_transaction_write" type="checkbox" v-model="actual_transaction_write" :disabled="!actual_transaction">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="invoice_write" name="invoice_write" type="checkbox" v-model="invoice_write" :disabled="!invoice">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="recalculate_balance_write" name="recalculate_balance_write" type="checkbox" v-model="recalculate_balance_write" :disabled="!recalculate_balance">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="invoice_notification_log_write" name="invoice_notification_log_write" type="checkbox" v-model="invoice_notification_log_write" :disabled="!invoice_notification_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="payment_write" name="payment_write" type="checkbox" v-model="payment_write" :disabled="!payment">
							...
							<tab label="Log" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_log" name="all_log" type="checkbox" v-model="all_log" @click="clickCkbAllLog">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_log_write" name="all_log_write" type="checkbox" v-model="all_log_write" @click="clickCkbAllLogW" :disabled="!all_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="ftp_log_write" name="ftp_log_write" type="checkbox" v-model="ftp_log_write" :disabled="!ftp_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="sip_register_write" name="sip_register_write" type="checkbox" v-model="sip_register_write" :disabled="!sip_register">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rate_mass_edit_log_write" name="rate_mass_edit_log_write" type="checkbox" v-model="rate_mass_edit_log_write" :disabled="!rate_mass_edit_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="import_log_write" name="import_log_write" type="checkbox" v-model="import_log_write" :disabled="!import_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rate_import_log_write" name="rate_import_log_write" type="checkbox" v-model="rate_import_log_write" :disabled="!rate_import_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="modification_log_write" name="modification_log_write" type="checkbox" v-model="modification_log_write" :disabled="!modification_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="retrieve_password_log_write" name="retrieve_password_log_write" type="checkbox" v-model="retrieve_password_log_write" :disabled="!retrieve_password_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="email_log_write" name="email_log_write" type="checkbox" v-model="email_log_write" :disabled="!email_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="auto_payment_log_write" name="auto_payment_log_write" type="checkbox" v-model="auto_payment_log_write" :disabled="!auto_payment_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="invoice_log_write" name="invoice_log_write" type="checkbox" v-model="invoice_log_write" :disabled="!invoice_log">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="user_sign_in_history_write" name="user_sign_in_history_write" type="checkbox" v-model="user_sign_in_history_write" :disabled="!user_sign_in_history">
							...
							<tab label="Management" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_management" name="all_management" type="checkbox" v-model="all_management" @click="clickCkbAllMng">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_management_write" name="all_management_write" type="checkbox" v-model="all_management_write" @click="clickCkbAllMngW" :disabled="!all_management">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="unclaimed_trunks_write" name="unclaimed_trunks_write" type="checkbox" v-model="unclaimed_trunks_write" :disabled="!unclaimed_trunks">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="carrier_write" name="carrier_write" type="checkbox" v-model="carrier_write" :disabled="!carrier">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="credit_management_write" name="all_management_write" type="checkbox" v-model="credit_management_write" :disabled="!credit_management">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="registration_write" name="registration_write" type="checkbox" v-model="registration_write" :disabled="!registration">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="wizard_write" name="wizard_write" type="checkbox" v-model="wizard_write" :disabled="!wizard">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="product_write" name="product_write" type="checkbox" v-model="product_write" :disabled="!product">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="client_rate_summary_write" name="client_rate_summary_write" type="checkbox" v-model="client_rate_summary_write" :disabled="!client_rate_summary">
							...
							<tab label="Monitoring" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_monitoring" name="all_monitoring" type="checkbox" v-model="all_monitoring" @click="clickCkbAllMoni">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_monitoring_write" name="all_monitoring_write" type="checkbox" v-model="all_monitoring_write" @click="clickCkbAllMoniW" :disabled="!all_monitoring">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="condition_write" name="condition_write" type="checkbox" v-model="condition_write" :disabled="!condition">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rule_write" name="rule_write" type="checkbox" v-model="rule_write" :disabled="!rule">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="action_write" name="action_write" type="checkbox" v-model="action_write" :disabled="!action">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="block_write" name="block_write" type="checkbox" v-model="block_write" :disabled="!block">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="loop_detection_write" name="loop_detection_write" type="checkbox" v-model="loop_detection_write" :disabled="!loop_detection">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="fraud_detection_write" name="fraud_detection_write" type="checkbox" v-model="fraud_detection_write" :disabled="!fraud_detection">
							...
							<tab label="Origination" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_origination" name="all_origination" type="checkbox" v-model="all_origination" @click="clickCkbAllOrig">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_origination_write" name="all_origination_write" type="checkbox" v-model="all_origination_write" @click="clickCkbAllOrigW" :disabled="!all_origination">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="clients_write" name="clients_write" type="checkbox" v-model="clients_write" :disabled="!clients">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="vendors_write" name="vendors_write" type="checkbox" v-model="vendors_write" :disabled="!vendors">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="billing_rule_write" name="billing_rule_write" type="checkbox" v-model="billing_rule_write" :disabled="!billing_rule">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="did_repository_write" name="did_repository_write" type="checkbox" v-model="did_repository_write" :disabled="!did_repository">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="orig_wizard_write" name="orig_wizard_write" type="checkbox" v-model="orig_wizard_write" :disabled="!orig_wizard">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="origination_static_routing_write" name="origination_static_routing_write" type="checkbox" v-model="origination_static_routing_write" :disabled="!origination_static_routing">
							...
							<tab label="Routing" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_routing" name="all_routing" type="checkbox" v-model="all_routing" @click="clickCkbAllRoute">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_routing_write" name="all_routing_write" type="checkbox" v-model="all_routing_write" @click="clickCkbAllRouteW" :disabled="!all_routing">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="routing_wizard_write" name="routing_wizard_write" type="checkbox" v-model="routing_wizard_write" :disabled="!routing_wizard">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="trunk_registration_write" name="trunk_registration_write" type="checkbox" v-model="trunk_registration_write" :disabled="!trunk_registration">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="digital_translation_write" name="digital_translation_write" type="checkbox" v-model="digital_translation_write" :disabled="!digital_translation">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="static_routing_write" name="static_routing_write" type="checkbox" v-model="static_routing_write" :disabled="!static_routing">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="disconnect_code_write" name="disconnect_code_write" type="checkbox" v-model="disconnect_code_write" :disabled="!disconnect_code">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="routing_plan_write" name="routing_plan_write" type="checkbox" v-model="routing_plan_write" :disabled="!routing_plan">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="dynamic_routing_write" name="dynamic_routing_write" type="checkbox" v-model="dynamic_routing_write" :disabled="!dynamic_routing">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="trunks_write" name="trunks_write" type="checkbox" v-model="trunks_write" :disabled="!trunks">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="block_lists_write" name="block_lists_write" type="checkbox" v-model="block_lists_write" :disabled="!block_lists">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="add_trunk_prefix_write" name="add_trunk_prefix_write" type="checkbox" v-model="add_trunk_prefix_write" :disabled="!add_trunk_prefix">
							...
							<tab label="Statistics" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_statistics" name="all_statistics" type="checkbox" v-model="all_statistics" @click="clickCkbAllStatis">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_statistics_write" name="all_statistics_write" type="checkbox" v-model="all_statistics_write" :disabled="!all_statistics" @click="clickCkbAllStatisW">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="host_based_report_write" name="host_based_report_write" type="checkbox" v-model="host_based_report_write" :disabled="!host_based_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="cdrs_list_write" name="cdrs_list_write" type="checkbox" v-model="cdrs_list_write" :disabled="!cdrs_list">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="spam_report_write" name="spam_report_write" type="checkbox" v-model="spam_report_write" :disabled="!spam_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="daily_usage_detail_report_write" name="daily_usage_detail_report_write" type="checkbox" v-model="daily_usage_detail_report_write" :disabled="!daily_usage_detail_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="disconnect_causes_write" name="disconnect_causes_write" type="checkbox" v-model="disconnect_causes_write" :disabled="!disconnect_causes">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="location_report_write" name="location_report_write" type="checkbox" v-model="location_report_write" :disabled="!location_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="usage_report_write" name="usage_report_write" type="checkbox" v-model="usage_report_write" :disabled="!usage_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="summary_report_write" name="all_statistisummary_report_writecs_write" type="checkbox" v-model="summary_report_write" :disabled="!summary_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="inbound_outbound_report_write" name="inbound_outbound_report_write" type="checkbox" v-model="inbound_outbound_report_write" :disabled="!inbound_outbound_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="profitability_analysis_write" name="profitability_analysis_write" type="checkbox" v-model="profitability_analysis_write" :disabled="!profitability_analysis">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="qos_summary_write" name="qos_summary_write" type="checkbox" v-model="qos_summary_write" :disabled="!qos_summary">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="monitors_write" name="monitors_write" type="checkbox" v-model="monitors_write" :disabled="!monitors">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="lnp_dip_record_write" name="lnp_dip_record_write" type="checkbox" v-model="lnp_dip_record_write" :disabled="!lnp_dip_record">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="daily_channel_usage_report_write" name="daily_channel_usage_report_write" type="checkbox" v-model="daily_channel_usage_report_write" :disabled="!daily_channel_usage_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="active_registration_write" name="active_registration_write" type="checkbox" v-model="active_registration_write" :disabled="!active_registration">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="stocks_write" name="stocks_write" type="checkbox" v-model="stocks_write" :disabled="!stocks">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="active_call_report_write" name="active_call_report_write" type="checkbox" v-model="active_call_report_write" :disabled="!active_call_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="dashboard_write" name="dashboard_write" type="checkbox" v-model="dashboard_write" :disabled="!dashboard">
							...
							<tab label="Switch" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_switch" name="all_switch" type="checkbox" v-model="all_switch" @click="clickCkbAllSwitch">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_switch_write" name="all_switch_write" type="checkbox" v-model="all_switch_write" @click="clickCkbAllSwitchW" :disabled="!all_switch">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="voip_gateway_write" name="voip_gateway_write" type="checkbox" v-model="voip_gateway_write" :disabled="!voip_gateway">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="clientrates_write" name="clientrates_write" type="checkbox" v-model="clientrates_write" :disabled="!clientrates">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="download_write" name="download_write" type="checkbox" v-model="download_write" :disabled="!download">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="uploads_write" name="uploads_write" type="checkbox" v-model="uploads_write" :disabled="!uploads">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="capacity_write" name="capacity_write" type="checkbox" v-model="capacity_write" :disabled="!capacity">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rate_table_write" name="rate_table_write" type="checkbox" v-model="rate_table_write" :disabled="!rate_table">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="time_profile_write" name="time_profile_write" type="checkbox" v-model="time_profile_write" :disabled="!time_profile">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="code_deck_write" name="code_deck_write" type="checkbox" v-model="code_deck_write" :disabled="!code_deck">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="us_jurisdiction_write" name="us_jurisdiction_write" type="checkbox" v-model="us_jurisdiction_write" :disabled="!us_jurisdiction">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="payment_term_write" name="payment_term_write" type="checkbox" v-model="payment_term_write" :disabled="!payment_term">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="random_ani_group_write" name="random_ani_group_write" type="checkbox" v-model="random_ani_group_write" :disabled="!random_ani_group">
							...
							<tab label="Template" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_template" name="all_template" type="checkbox" v-model="all_template" @click="clickCkbAllTemp">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_template_write" name="all_template_write" type="checkbox" v-model="all_template_write" @click="clickCkbAllTempW" :disabled="!all_template">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="egress_trunk_template_write" name="egress_trunk_template_write" type="checkbox" v-model="egress_trunk_template_write" :disabled="!egress_trunk_template">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="ingress_trunk_template_write" name="ingress_trunk_template_write" type="checkbox" v-model="ingress_trunk_template_write" :disabled="!ingress_trunk_template">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rate_upload_template_write" name="rate_upload_template_write" type="checkbox" v-model="rate_upload_template_write" :disabled="!rate_upload_template">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="carrier_template_write" name="carrier_template_write" type="checkbox" v-model="carrier_template_write" :disabled="!carrier_template">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rate_email_template_write" name="rate_email_template_write" type="checkbox" v-model="rate_email_template_write" :disabled="!rate_email_template">
							...
							<tab label="Agent" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_agent" name="all_agent" type="checkbox" v-model="all_agent" @click="clickCkbAllAgent">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_agent_write" name="all_agent_write" type="checkbox" v-model="all_agent_write" @click="clickCkbAllAgentW" :disabled="!all_agent">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="commission_report_write" name="commission_report_write" type="checkbox" v-model="commission_report_write" :disabled="!commission_report">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="agent_management_write" name="agent_management_write" type="checkbox" v-model="agent_management_write" :disabled="!agent_management">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="commission_history_write" name="commission_history_write" type="checkbox" v-model="commission_history_write" :disabled="!commission_history">
							...
							<tab label="Tools" class="" icon="dnl_icon dnl_arrow-point-to-right">
								<section class="role_section">
									...
									<div class="col-sm-8">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_tools" name="all_tools" type="checkbox" v-model="all_tools" @click="clickCkbAllTools">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="all_tools_write" name="all_tools_write" type="checkbox" v-model="all_tools_write" @click="clickCkbAllToolsW" :disabled="!all_tools">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="call_simulation_write" name="call_simulation_write" type="checkbox" v-model="call_simulation_write" :disabled="!call_simulation">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rerate_write" name="rerate_write" type="checkbox" v-model="rerate_write" :disabled="!rerate">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="sip_packet_search_write" name="sip_packet_search_write" type="checkbox" v-model="sip_packet_search_write" :disabled="!sip_packet_search">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input id="rate_generation_write" name="rate_generation_write" type="checkbox" v-model="rate_generation_write" :disabled="!rate_generation">
...
module.exports = {
		...
		'allow_delete_invoice': function() {
			if (this.allow_delete_invoice) {
				if (this.allow_delete_payment &&
					...
					this.all_finance_perm = true;
			}
			else
				this.all_finance_perm = false;
		},
	...
	methods: {
		...
		clickCkbAllToolsW() {
			if (this.all_tools_write) {
				this.call_simulation_write = true;
				this.rerate_write = true;
				this.sip_packet_search_write = true;
				this.rate_generation_write = true;
			}
			else {
				this.call_simulation_write = false;
				this.rerate_write = false;
		...
		clickCkbAllTools() {
			if (this.all_tools) {
				this.call_simulation = true;
				this.rerate = true;
				this.sip_packet_search = true;
				this.rate_generation = true;
			}
			else {
				this.call_simulation = false;
				this.rerate = false;
		...
		clickCkbAllAgentW() {
			if (this.all_agent_write) {
				this.commission_report_write = true;
				this.agent_management_write = true;
				this.commission_history_write = true;
			}
			else {
				this.commission_report_write = false;
				this.agent_management_write = false;
		...
		clickCkbAllAgent() {
			if (this.all_agent) {
				this.commission_report = true;
				this.agent_management = true;
				this.commission_history = true;
			}
			else {
				this.commission_report = false;
				this.agent_management = false;
		...
		clickCkbAllTempW() {
			if (this.all_template_write) {
				this.egress_trunk_template_write = true;
				this.ingress_trunk_template_write = true;
				this.rate_upload_template_write = true;
				this.carrier_template_write = true;
				this.rate_email_template_write = true;
			}
			else {
				this.egress_trunk_template_write = false;
				this.ingress_trunk_template_write = false;
		...
		clickCkbAllTemp() {
			if (this.all_template) {
				this.egress_trunk_template = true;
				this.ingress_trunk_template = true;
				this.rate_upload_template = true;
				this.carrier_template = true;
				this.rate_email_template = true;
			}
			else {
				this.egress_trunk_template = false;
				this.ingress_trunk_template = false;
		...
		clickCkbAllSwitchW() {
			if (this.all_switch_write) {
				this.voip_gateway_write = true;
				this.clientrates_write = true;
				this.download_write = true;
				this.uploads_write = true;
				this.capacity_write = true;
				this.rate_table_write = true;
				this.time_profile_write = true;
				this.code_deck_write = true;
				this.us_jurisdiction_write = true;
				this.payment_term_write = true;
				this.random_ani_group_write = true;
			}
			else {
				this.voip_gateway_write = false;
				this.clientrates_write = false;
		...
		clickCkbAllSwitch() {
			if (this.all_switch) {
				this.voip_gateway = true;
				this.clientrates = true;
				this.download = true;
				this.uploads = true;
				this.capacity = true;
				this.rate_table = true;
				this.time_profile = true;
				this.code_deck = true;
				this.us_jurisdiction = true;
				this.payment_term = true;
				this.random_ani_group = true;
			}
			else {
				this.voip_gateway = false;
				this.clientrates = false;
		...
		clickCkbAllStatisW() {
			if (this.all_statistics_write) {
				this.host_based_report_write = true;
				this.cdrs_list_write = true;
				this.spam_report_write = true;
				this.daily_usage_detail_report_write = true;
				this.disconnect_causes_write = true;
				this.location_report_write = true;
				this.usage_report_write = true;
				this.summary_report_write = true;
				this.inbound_outbound_report_write = true;
				this.profitability_analysis_write = true;
				this.qos_summary_write = true;
				this.monitors_write = true;
				this.lnp_dip_record_write = true;
				this.daily_channel_usage_report_write = true;
				this.active_registration_write = true;
				this.stocks_write = true;
				this.active_call_report_write = true;
				this.dashboard_write = true;
			}
			else {
				this.host_based_report_write = false;
				this.cdrs_list_write = false;
		...
		clickCkbAllStatis() {
			if (this.all_statistics) {
				this.host_based_report = true;
				this.cdrs_list = true;
				this.spam_report = true;
				this.daily_usage_detail_report = true;
				this.disconnect_causes = true;
				this.location_report = true;
				this.usage_report = true;
				this.summary_report = true;
				this.inbound_outbound_report = true;
				this.profitability_analysis = true;
				this.qos_summary = true;
				this.monitors = true;
				this.lnp_dip_record = true;
				this.daily_channel_usage_report = true;
				this.active_registration = true;
				this.stocks = true;
				this.active_call_report = true;
				this.dashboard = true;
			}
			else {
				this.host_based_report = false;
		...
		clickCkbAllRouteW() {
			if (this.all_routing_write) {
				this.routing_wizard_write = true;
				this.trunk_registration_write = true;
				this.digital_translation_write = true;
				this.static_routing_write = true;
				this.disconnect_code_write = true;
				this.routing_plan_write = true;
				this.dynamic_routing_write = true;
				this.trunks_write = true;
				this.block_lists_write = true;
				this.add_trunk_prefix_write = true;
			}
			else {
				this.routing_wizard_write = false;
				this.trunk_registration_write = false;
		...
		clickCkbAllRoute() {
			if (this.all_routing) {
				this.routing_wizard = true;
				this.trunk_registration = true;
				this.digital_translation = true;
				this.static_routing = true;
				this.disconnect_code = true;
				this.routing_plan = true;
				this.dynamic_routing = true;
				this.trunks = true;
				this.block_lists = true;
				this.add_trunk_prefix = true;
			}
			else {
				this.routing_wizard = false;
				this.trunk_registration = false;
		...
		clickCkbAllOrigW() {
			if (this.all_origination_write) {
				this.clients_write = true;
				this.vendors_write = true;
				this.billing_rule_write = true;
				this.did_repository_write = true;
				this.orig_wizard_write = true;
				this.origination_static_routing_write = true;
			}
			else {
				this.clients_write = false;
				this.vendors_write = false;
		...
		clickCkbAllOrig() {
			if (this.all_origination) {
				this.clients = true;
				this.vendors = true;
				this.billing_rule = true;
				this.did_repository = true;
				this.orig_wizard = true;
				this.origination_static_routing = true;
			}
			else {
				this.clients = false;
				this.vendors = false;
		...
		clickCkbAllMoniW() {
			if (this.all_monitoring_write) {
				this.condition_write = true;
				this.rule_write = true;
				this.action_write = true;
				this.block_write = true;
				this.loop_detection_write = true;
				this.fraud_detection_write = true;
			}
			else {
				this.condition_write = false;
				this.rule_write = false;
		...
		clickCkbAllMoni() {
			if (this.all_monitoring) {
				this.condition = true;
				this.rule = true;
				this.action = true;
				this.block = true;
				this.loop_detection = true;
				this.fraud_detection = true;
			}
			else {
				this.condition = false;
				this.rule = false;
		...
		clickCkbAllMngW() {
			if (this.all_management_write) {
				this.unclaimed_trunks_write = true;
				this.carrier_write = true;
				this.credit_management_write = true;
				this.registration_write = true;
				this.wizard_write = true;
				this.product_write = true;
				this.client_rate_summary_write = true;
			}
			else {
				this.unclaimed_trunks_write = false;
				this.carrier_write = false;
		...
		clickCkbAllMng() {
			if (this.all_management) {
				this.unclaimed_trunks = true;
				this.carrier = true;
				this.credit_management = true;
				this.registration = true;
				this.wizard = true;
				this.product = true;
				this.client_rate_summary = true;
			}
			else {
				this.unclaimed_trunks = false;
				this.carrier = false;
		...
		clickCkbAllLogW() {
			if (this.all_log_write) {
				this.ftp_log_write = true;
				this.sip_register_write = true;
				this.rate_mass_edit_log_write = true;
				this.import_log_write = true;
				this.rate_import_log_write = true;
				this.modification_log_write = true;
				this.retrieve_password_log_write = true;
				this.email_log_write = true;
				this.auto_payment_log_write = true;
				this.invoice_log_write = true;
				this.user_sign_in_history_write = true;
			}
			else {
				this.ftp_log_write = false;
				this.sip_register_write = false;
		...
		clickCkbAllLog() {
			if (this.all_log) {
				this.ftp_log = true;
				this.sip_register = true;
				this.rate_mass_edit_log = true;
				this.import_log = true;
				this.rate_import_log = true;
				this.modification_log = true;
				this.retrieve_password_log = true;
				this.email_log = true;
				this.auto_payment_log = true;
				this.invoice_log = true;
				this.user_sign_in_history = true;
			}
			else {
				this.ftp_log = false;
				this.sip_register = false;
		...
		clickCkbAllFinW() {
			if (this.all_finance_write) {
				this.mutual_transaction_write = true;
				this.past_due_notification_log_write = true;
				this.regenerate_balance_write = true;
				this.past_due_summary_write = true;
				this.carrier_invoice_history_write = true;
				this.auto_invoice_management_write = true;
				this.actual_transaction_write = true;
				this.invoice_write = true;
				this.recalculate_balance_write = true;
				this.invoice_notification_log_write = true;
				this.payment_write = true;
			}
			else {
				this.mutual_transaction_write = false;
				this.past_due_notification_log_write = false;
		...
		clickCkbAllFin() {
			if (this.all_finance) {
				this.mutual_transaction = true;
				this.past_due_notification_log = true;
				this.regenerate_balance = true;
				this.past_due_summary = true;
				this.carrier_invoice_history = true;
				this.auto_invoice_management = true;
				this.actual_transaction = true;
				this.invoice = true;
				this.recalculate_balance = true;
				this.invoice_notification_log = true;
				this.payment = true;
			}
			else {
				this.mutual_transaction = false;
		...
		clickCkbAllConfW() {
			if (this.all_config_write) {
				this.users_write = true;
				this.role_write = true;
				this.system_setting_write = true;
				this.invoice_setting_write = true;
				this.payment_setting_write = true;
				this.global_route_error_write = true;
				this.mail_sender_write = true;
				this.system_modules_write = true;
				this.mail_template_write = true;
				this.login_page_content_write = true;
				this.cdr_generation_format_write = true;
				this.carrier_group_write = true;
				this.trunk_group_write = true;
				this.syspris_write = true;
				this.ftp_job_write = true;
				this.fail_over_rule_write = true;
				this.carrier_portal_cdr_field_write = true;
		...
		clickCkbAllConf() {
			if (this.all_config) {
				...
				this.payment_setting = true;
				this.global_route_error = true;
				this.mail_sender = true;
				this.system_modules = true;
				this.mail_template = true;
				this.login_page_content = true;
				this.cdr_generation_format = true;
				this.carrier_group = true;
				this.trunk_group = true;
				this.syspris = true;
				this.ftp_job = true;
				this.fail_over_rule = true;
				this.carrier_portal_cdr_field = true;
