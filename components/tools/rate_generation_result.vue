    ...
    <div class="container-fluid">
        <div class="row">
            <div class="wrapper single">
                ...
                <router-link to="/tools/rate_generation" class="btn btn_white back">
                                ...
                                <tbody>
                                    <tr v-for="code in filterBy(codes, search)">
                                        <td class="centred_checkbox">
                                            <div class="checkbox checkbox-success">
                                                <input :id="'selected-' + code.id" :name="'selected-' + code.id" type="checkbox" v-model="code.selected">
                                                <label :for="'selected-' + code.id"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" v-model="code.code" class="form-control" v-if="code.is_editing">
                                            {{!code.is_editing?code.code: ''}}
                                        </td>
                                        <td>
                                            <input type="text" v-model="code.name" class="form-control" v-if="code.is_editing">
                                            {{!code.is_editing?code.name: ''}}
                                        </td>
                                        <td>
                                            <input type="text" v-model="code.country" class="form-control" v-if="code.is_editing">
                                            {{!code.is_editing?code.country: ''}}
                                        </td>
                                        <td>
                                            <input type="text" v-model="code.rate" class="form-control" v-if="code.is_editing">
                                            {{!code.is_editing?code.rate: ''}}
                                        </td>
                                        <td>
                                            <input type="text" v-model="code.min_time" class="form-control" v-if="code.is_editing">
                                            {{!code.is_editing?code.min_time: ''}}
                                        </td>
                                        <td>
                                            <input type="text" v-model="code.interval" class="form-control" v-if="code.is_editing">
                                            {{!code.is_editing?code.interval: ''}}
                                        </td>
                                        ...
                                        <td>
                                            <a class="action action_save" data-toggle="tooltip" data-placement="top" title="Save" v-if="code.is_editing" @click="validateRateGenResult(code)">
                                                <span class="dnl_icon dnl_save"></span>
                                            </a>
                                            <a class="action action_login_as" data-toggle="tooltip" data-placement="top" title="Cancel" v-if="code.is_editing" @click="cancelRateGenResult(code)">
                                                <span class="dnl_icon dnl_exit"></span>
                                            </a>
                                            <a class="action action_edit" data-toggle="tooltip" data-placement="top" title="Edit" v-if="!code.is_editing" @click="editRateGenResult(code)">
                                                <span class="dnl_icon dnl_action_edit"></span>
                                            </a>
                                            <a class="action action_menu" data-toggle="tooltip" data-placement="top" title="View LCR" v-if="!code.is_editing" @click="showModal='view_lcr'">
...
module.exports = {
    ...
    methods: {
        cancelRateGenResult(item) {
            item.is_editing = false;
        },
        validateRateGenResult(item) {
            item.is_editing = false;
        },
        editRateGenResult(item) {
