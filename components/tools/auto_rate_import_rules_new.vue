      ...
      <div class="row">
		<div class="wrapper single">
			...
			<ol class="breadcrumb">
				  ...
				  <li class="breadcrumb-item active">Auto Rate Import Rules Editor</li>
			</ol>
			<h1 class="page-header">Auto Rate Import Rules Editor</h1>
			<router-link to="/tools/auto_rate_import_rules" class="btn btn_white back"><span class="dnl_icon dnl_import"></span> Back </router-link>
			<div class="white_pad">
				<tabs class="vertical">
					...
					<tab label="Attachment Handling" class="" icon="dnl_icon dnl_arrow-point-to-right">
						<section class="role_section">
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<div class="checkbox checkbox-success">
										<input id="send_trunk_update" name="send_trunk_update" type="checkbox" v-model="template.send_trunk_update"> 
					...
					<tab label="Violation Check" class="" icon="dnl_icon dnl_arrow-point-to-right">
						<section class="role_section fix-select">
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="form-group m-top-33">
									<div class="checkbox checkbox-success">
										<input id="is_daily_cdr_delivery" name="is_daily_cdr_delivery" type="checkbox" v-model="template.is_daily_cdr_delivery"> 
										<label for="is_daily_cdr_delivery">Enable Daily CDR Delivery</label>
									</div>
								</div>
								<div class="form-group m-top-33">
									<div class="checkbox checkbox-success">
								...
								<div class="form-group m-top-33">
									<div class="checkbox checkbox-success">
										<input id="is_daily_usage_summary" name="is_daily_usage_summary" type="checkbox" v-model="template.is_daily_usage_summary"> 
										<label for="is_daily_usage_summary">Enable Daily Usage Summary</label>
									</div>
								</div>
								<div class="form-group m-top-33">
									<div class="checkbox checkbox-success">
										<input id="is_daily_balance_summary" name="is_daily_balance_summary" type="checkbox" v-model="template.is_daily_balance_summary"> 
										<label for="is_daily_balance_summary">Daily Balance Summary</label>
									</div>
								</div>
								<div class="form-group m-top-33">
									<div class="checkbox checkbox-success">
					...
					<tab label="Special Handling" class="" icon="dnl_icon dnl_arrow-point-to-right">
						<section class="role_section">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<span v-show="errors.has('scc_percent')" class="help is-danger">{{ errors.first('scc_percent') }}</span>% overall invoice minute is below or equal to <select2 class="scc_below_options" :options="scc_below_options" v-model="template.scc_below"></select2> second, then an additional charge of <input type="text" name="scc_charge" v-model="template.scc_charge" class="form-control small" :class="{'input': true, 'is-danger': errors.has('scc_charge') }" v-validate="'numeric'" placeholder="">
	...
	module.exports = {
		...
		data: function(){
            return {
				low_balance_config: {},
				group_by_options: [
					{id: 'by_country', text: 'By Country'},
					{id: 'by_code_name', text: 'By Code Name'},
					{id: 'by_code', text: 'By Code'},
				],
				...
				emptyTemplate: {
					...
					non_zero_only: true,
					group_by: 'by_country',
					is_daily_usage_summary: false,
					send_daily_alert_on: false,
					template_name: '',
					// profit_margin: 0,
		...
		methods: {
			...
			organizeTemplateData(data) {
				...
				this.low_balance_config = data.low_balance_config;
			...
			getCarrierTemplateForRequest() {
				const carrier_template = JSON.parse( JSON.stringify( this.carrier_template ) )
