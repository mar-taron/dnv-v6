	...
	watch: {
		'period': function() {
			if(this.period == 'Custom')
			{
				...
				this.submitted_time2 == ""
			} else if(this.period == 'Today')
			{
				this.submitted_time1 = getStartTimeOfToday();
				this.submitted_time2 = getEndTimeOfToday();
			} else if(this.period == 'Current week')
			{
				this.submitted_time1 = getStartTimeOfCurrentWeek();
				this.submitted_time2 = getEndTimeOfCurrentWeek();
			} else if(this.period == 'Current month')
			{
				this.submitted_time1 = getStartTimeOfCurrentMonth();
				this.submitted_time2 = getEndTimeOfCurrentMonth();
			}
		},
	},	
	methods: {
