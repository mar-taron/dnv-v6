				...
				<div class="timeline">
					...
					<div class="chart_content">
						<div class="table_filters marged-40">
							...
							<div class="margin-left-0 inline-block mar-bot">
							...
							<a class="mar-top btn btn-primary mini pull-right" v-on:click="refresh()">
...
module.exports = {
	...
	methods: {
		...
		query() {
			...
			const url = api.getEndpointUrl() + this.apiUrl + "?page=" + page + "&per_page=" + countperpage + 
			"&start_time_lt<" + time + "<end_time_lt&order_by=id&order_dir=desc";
			console.log(url);
			this.$http.get(url,
				{
					headers: {
		...
		handleChange() {
            ...
            if (_.indexOf(this.log_table_columns, 'Progress') != -1) {
...
@media (max-width:480px){
	#app > div.container-fluid > div > div > div > div.chart_content > div.table_filters.marged-40 > a{
