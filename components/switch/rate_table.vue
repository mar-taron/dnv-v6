      ...
      <div class="row">
		<div class="wrapper single">
			...
			<div class="btn-group" role="group">
			  ...
			  <button type="button" class="btn btn-default delete_icon" @click="deleteAll">
				  <span class="dnl_icon dnl_action_delete"></span> Delete All
			  </button>
			  <button type="button" class="btn btn-default delete_icon" @click="deleteSelected">
						...
						<table class="table table-striped table-hover agents ">
						  <thead>
							<tr>
                              ...
                              <th v-if="showcolumns[5]">Updated at<span class="dnl_icon dnl_sort pull-right"></span></th>
		...
		data: function(){
            return {
				...
				rate_table_columns: ['Name', 'Code Deck', 'Usage Count', 
						'Billing Method', 'Rate Type', 'Updated at', 'Updated by', 'Action'],
...
<style>
	...
	.btn-group .btn.btn-default.delete_icon {
		padding-top: 9px;
	}
</style>
