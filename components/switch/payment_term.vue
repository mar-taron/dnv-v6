                ...
                <div class="white_pad table_wrap">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-hover aliases">
                            <thead>
                                <tr>
                                    <th class="table_column" @click="sortName" v-if="showcolumns[0]">Payment Term<span class="dnl_icon dnl_sort pull-right"></span></th>
                                    <th v-if="showcolumns[1]" class="text-center">Invoicing Cycle</th>
                                    <th v-if="showcolumns[2]">Grace Period(Days)</th>
                                    <th v-if="showcolumns[3]">Notify(Days)</th>
                                    <th v-if="showcolumns[4]">Usage Count</th>
