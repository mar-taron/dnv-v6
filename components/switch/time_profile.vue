							...
							<thead>
								<tr>
									<th v-if="showcolumns[0]" @click="sortColumn('name')">Name
										<a><span class="dnl_icon dnl_sort pull-right"></span></a>
									</th>
									<th v-if="showcolumns[1]" @click="sortColumn('type')">Type
										<a><span class="dnl_icon dnl_sort pull-right"></span></a>
									</th>
									<th v-if="showcolumns[2]" @click="sortColumn('start_day_of_week')">Start Weekday
										<a><span class="dnl_icon dnl_sort pull-right"></span></a>
									</th>
									<th v-if="showcolumns[3]" @click="sortColumn('end_day_of_week')">End Weekday
										<a><span class="dnl_icon dnl_sort pull-right"></span></a>
									</th>
									<th v-if="showcolumns[4]" @click="sortColumn('start_time')">Start Time
										<a><span class="dnl_icon dnl_sort pull-right"></span></a>
									</th>
									<th v-if="showcolumns[5]" @click="sortColumn('end_time')">End Time
										<a><span class="dnl_icon dnl_sort pull-right"></span></a>
									</th>
							...
							<tbody>
								...
								<tr v-for="time_profile in filterBy(time_profile_list, search)">
									<td v-if="showcolumns[0]">
										<router-link :to="'/switch/time_profile/edit/'+time_profile.time_profile_id" class="blue_link">
											{{time_profile.name}}
										</router-link>
									</td>
