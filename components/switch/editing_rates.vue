	...
	<div class="container-fluid">
      <div class="row">
		<div class="wrapper single">
			...
			<tabs>
				<tab label="Rates" class="" icon="dnl_icon dnl_list" :selected="tab_type == undefined">
				...
				<tab label="Import" class="" icon="dnl_icon dnl_import" :selected="tab_type == 'import'">
					<div class="row">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="form-group full-width-select">
                            ...
                            <select2 :options="rate_upload_template_options" v-model="rate_upload_template">
                            </select2>
                        </div>
                        <div class="form-group full-width-select" v-if="for_rate_record!='delete_existing_records'">
                            <label>End Date Time:</label>
                            <el-date-picker v-model="end_date_time" type="datetime" placeholder="End Date Time"></el-date-picker>
                        </div>
                        <div class="form-group full-width-select" v-if="for_rate_record!='delete_existing_records'">
                        ...
                        <div class="form-group full-width-select">
                            ...
                            <select2 :options="effective_date_format_options" v-model="effective_date_format">
                            </select2>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="radio radio-success m-top-5">
                                <input id="radio-1" class="radio-custom" name="duplicates" type="radio" value="delete_existing_records" v-model="for_rate_record">
                                <label for="radio-1" class="radio-custom-label">Delete Existing Records</label>
                            </div>
                            <div class="radio radio-success m-left-10 m-top-5">
                                <input id="radio-2" class="radio-custom" name="duplicates" type="radio" value="end_date_existing_records" v-model="for_rate_record">
                                <label for="radio-2" class="radio-custom-label">End-Date Existing Records</label>
                            </div>
                            <div class="radio radio-success m-left-10 m-top-5">
                                <input id="radio-3" class="radio-custom" name="duplicates" type="radio" value="end_date_all_records" v-model="for_rate_record">
                        ...
                        <div class="row">
                            <!--<div class="col-sm-6">
                                <div class="form-group full-width-select">
                                    ...
                                    <select2 :options="code_name_matching_options" v-model="code_name_matching">
                                    </select2>
                                </div>
                            </div>-->
                            <div class="col-sm-6">
					...
					<div class="row">
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="form-group m-top-33">
                                <div class="checkbox checkbox-success">
                                    <input id="enable_rep_grouping" name="enable_rep_grouping" type="checkbox">
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group full-width-select">
                                ...
                                <select2 :options="export_options" v-model="column_1"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #2:</label>
                                <select2 :options="export_options" v-model="column_2"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #3:</label>
                                <select2 :options="export_options" v-model="column_3"></select2>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group full-width-select">
                                <label for="username">Column #4:</label>
                                <select2 :options="export_options" v-model="column_4"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #5:</label>
                                <select2 :options="export_options" v-model="column_5"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #6:</label>
                                <select2 :options="export_options" v-model="column_6"></select2>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group full-width-select">
                                <label for="username">Column #7:</label>
                                <select2 :options="export_options" v-model="column_7"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #8:</label>
                                <select2 :options="export_options" v-model="column_8"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #9:</label>
                                <select2 :options="export_options" v-model="column_9"></select2>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group full-width-select">
                                <label for="username">Column #10:</label>
                                <select2 :options="export_options" v-model="column_10"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #11:</label>
                                <select2 :options="export_options" v-model="column_11"></select2>
                            </div>
                            <div class="form-group full-width-select">
                                <label for="username">Column #12:</label>
                                <select2 :options="export_options" v-model="column_12"></select2>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group full-width-select">
...
<script>   
	...
	module.exports = {
		...
		data: function(){
            return {
                for_rate_record: 'delete_existing_records',
                gmt: '+0:00',
                gmt_options: [
                ...
                code_name_matching_options: [
                    {id: '1', text: 'Re-populate Country and Code Name with Selected Code Deck'},
                    {id: '2', text: 'Re-populate Country and Code Name with Selected Code Deck if not available'},
                ],
                effective_date_format_options: [
                ...
                rate_upload_template_options: [
                    {id: '', text: 'Specify New Upload Rule'},
                    {id: '3', text: 'US test'},
                    {id: '4', text: 'A-Z test'},
                    {id: '2', text: 'rate upload template'},
                ],
                pageOne: {
					currentPage: 1,
					totalPages: 10,
          ...
          { id: '5', text: 'New Rate' },
          { id: '6', text: 'Setup Fee' },
          { id: '7', text: 'Effective Date' },
          { id: '8', text: 'End Date' },
          { id: '9', text: 'Min Time' },
          { id: '10', text: 'Interval' },
          { id: '11', text: 'Profile' },
          { id: '12', text: 'Inter Rate' },
          { id: '13', text: 'Inter Rate' },
          { id: '14', text: 'Local Rate' },
          { id: '14', text: 'Change Status' }
        ],
				selected2: 0,
				options2: [
        ...
        ...mapActions({
            ...
            exportCSV: function () {                 
                ...
                // If header text is presented then insert it as first row
                if (this.header_text !== '') {
                    var headerWords = this.header_text.split(' ');
                    csvArray.push(headerWords);

                }
                var temp_fields = [this.column_1, this.column_2, this.column_3, this.column_4, this.column_5, this.column_6, this.column_7, this.column_8, this.column_9, this.column_10,this.column_11, this.column_12, this.column_13,this.column_14, this.column_15];
                var final_fields = [];
                      var options = this.export_options;
                    var final_options = [];
                ...
                this.templateList.forEach(function (temp, i) {
                    ...
                    if (_.indexOf(final_fields, 'Code') != -1) {
                        values.push(temp.code + "");
                    }
                    if (_.indexOf(final_fields, 'Code Name') != -1) {
                        values.push(temp.code_name + "");
                    }
                    if (_.indexOf(final_fields, 'Country') != -1) {
                        values.push(temp.country + "");
                    }
                    if (_.indexOf(final_fields, 'Rate') != -1) {
                        values.push(temp.rate + "");
                    }
                    if (_.indexOf(final_fields, 'Intra Rate') != -1) {
                        values.push(temp.inter_rate + "");
                    }
                    if (_.indexOf(final_fields, 'Effective Date') != -1) {
                        values.push(temp.effective_date + "");
                    }
                    if (_.indexOf(final_fields, 'End Date') != -1) {
                        values.push(temp.end_date + "");
                    }

                    if (_.indexOf(final_fields, 'Setup Fee') != -1) {
                        values.push(temp.setup_fee + "");
                    }
//                    if (_.indexOf(final_fields, 'Time Profile') != -1) {
//                        values.push(temp.time_profile_id + "");
//                    }

                    if (_.indexOf(final_fields, 'Local Rate') != -1) {
                        values.push(temp.local_rate + "");
                    }

                    if (_.indexOf(final_fields, 'Min Time') != -1) {
                ...
                // If footer text is presented insert it as last row
                if (this.footer_text !== '') {
