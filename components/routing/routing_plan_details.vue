                ...
                <tabs>
                    <tab label="Route List" class="" icon="dnl_icon dnl_list" selected>
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-default inline_fixer" @click="showRouteModal='add_route'">
                            ...
                            <table class="table table-striped table-hover aliases">
                                <thead>
                                    <tr>
                                        ...
                                        <th v-if="showcolumns[6]" rowspan="2" colspan="1">Updated At</th>
                                        <th v-if="showcolumns[7]" rowspan="2" colspan="1">Updated By</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_6">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_7">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_8">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_9">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_10">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_11">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select class="selectable" v-model="column_12">
                                        <option v-for="item in column_options" v-bind:value="item.id">
                                            {{ item.text }}
                                        </option>
                                    </select>
        ...
        <modal v-if="showRouteModal=='add_route' || showRouteModal=='edit_route'" @close="showRouteModal = ''" class="big_modal">
            ...
            <div slot="body">
                <form class="form">
                    ...
                    <div>
                        <a @click="validateBeforeSubmit" type="submit" class="btn btn-primary submit mini">Submit</a>
                        <a @click="closeRouteModal" class="btn btn-default cancel mini">Cancel</a>
                    </div>
                </form>
            </div>
            <div slot="footer">
...
module.exports = {
    ...
    data: function () {
        return {
            column_options: [
                {id: 'ani_prefix', text: 'ani_prefix'},
                {id: 'ani_min_length', text: 'ani_min_length'},
                {id: 'ani_max_length', text: 'ani_max_length'},
                {id: 'dnis_prefix', text: 'dnis_prefix'},
                {id: 'dnis_min_length', text: 'dnis_min_length'},
                {id: 'dnis_max_length', text: 'dnis_max_length'},
                {id: 'route_type', text: 'route_type'},
                {id: 'dynamic_route_name', text: 'dynamic_route_name'},
                {id: 'static_route_name', text: 'static_route_name'},
                {id: 'intra_static_route_name', text: 'intra_static_route_name'},
                {id: 'inter_static_route_name', text: 'inter_static_route_name'},
                {id: 'jurisdiction_country', text: 'jurisdiction_country'},
            ],
            with_headers_row: false,
            data_format_options: [
                {id: 'csv', text: 'CSV'},
                {id: 'xls', text: 'XLS'},
            ],
            ...
            footer_text: '',
            column_1: 'ani_prefix',
            column_2: 'ani_min_length',
            column_3: 'ani_max_length',
            column_4: 'dnis_prefix',
            column_5: 'dnis_min_length',
            column_6: 'dnis_max_length',
            column_7: 'route_type',
            column_8: 'dynamic_route_name',
            column_9: 'static_route_name',
            column_10: 'intra_static_route_name',
            column_11: 'inter_static_route_name',
            column_12: 'jurisdiction_country',
            ...
            route_table_columns: ['ID', 'Match Prefix', 'Route Type',
                'Routing', 'ANI Length', 'DNIS Length', 'Updated At', 'Updated By', 'Action'],
    ...
    methods: {
            ...
            if (this.showRouteModal == "add_route") {
                this.$http.post(api.getEndpointUrl() + '/v1/route/plan/' + this.routing_plan_id +  '/add_route',
                    ...
                    function (response) {
                        ...
                        let index = _.findIndex(this.dynamic_lists, elem => elem.id   === this.dynamic_routing)
                        var dynamic_name = '';
                        if(~index)
                            dynamic_name = this.dynamic_lists[index].text
                        this.lists.push({
                            route_id: response.body.object_id,
                            ani_max_length: this.ani_max_length,
                            dnis_max_length: this.dnis_max_length,
                            route_type: this.route_type,
                            dynamic_route_name: dynamic_name,
                            ANI_min: this.ani_min_length,
                            ANI_max: this.ani_max_length,
                            DNIS_min: this.dnis_min_length,
                            DNIS_max: this.dnis_max_length
        ...
        validateBeforeSubmit() {
			...
			this.$validator.validateAll().then(() => {
                if(vm.dynamic_routing == 0) {
                    vm.setMessage({
						message: 'Dynamic Routing is required',
						type: 'error'
					})
                    isValidOk = false;
                    return;
        ...
        handleChange() {
            ...
            if (_.indexOf(this.route_table_columns, 'Updated By') != -1) {
