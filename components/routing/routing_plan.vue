						...
						<table class="table table-striped table-hover agents ">
							<thead>
								<tr>
									...
									<th v-if="showcolumns[1]" @click="sortColumn('usage_count')">Usage Count
										<span class="dnl_icon dnl_sort pull-right"></span>
									</th>
									<th v-if="showcolumns[2]" @click="sortColumn('update_at')">Updated at
										<span class="dnl_icon dnl_sort pull-right"></span>
									</th>
									<th v-if="showcolumns[3]" @click="sortColumn('update_by')">Updated by
										<span class="dnl_icon dnl_sort pull-right"></span>
									</th>
...
module.exports = {
	...
	data: function () {
		return {
			...
			plan_table_columns: ['Name', 'Usage Count', 'Updated at',
				'Updated by', 'Action'],
	...
	methods: {
		...
		handleChange() {
			...
			if (_.indexOf(this.plan_table_columns, 'Updated at') != -1) {
			...
			if (_.indexOf(this.plan_table_columns, 'Updated by') != -1) {
