    ...
    <div class="container-fluid">
        <div class="row">
            <div class="wrapper single">
                ...
                <form class="form">
                    <div class="margin-content-top white_pad">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <input type="text" name="media_timeout" v-model="media_timeout" class="form-control" placeholder="Enter PDD Timeout">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <input type="text" name="max_duration" v-model="max_duration" class="form-control" :class="{'input': true, 'is-danger': errors.has('max_duration') }" v-validate="'required|numeric'" placeholder="Enter Max Duration">
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <input type="text" name="ring_timer" v-model="ring_timer" class="form-control" :class="{'input': true, 'is-danger': errors.has('ring_timer') }" v-validate="'required|numeric'" placeholder="Enter Ring Timer">
                            ...
                            <div class="col-md-3 col-sm-4" v-if="type == 'ingress'">
                                ...
                                <select class="selectable" v-model="ignore_early_media">
                                    <option v-for="item in ignore_early_media_options" v-bind:value="item.id">
                                        {{ item.text }}
                                    </option>
                                </select>
                            </div>
...
module.exports = {
    ...
    methods: {
        ...
        getEgressForRequest() {
            ...
            //   this.req_egress.media_timeout = this.media_timeout;
        ...
        getIngressForRequest() {
            this.req_ingress.host_routing_strategy = this.multi_host_routing_strategy;
            if(this.media_timeout != null)
                this.req_ingress.media_timeout = this.media_timeout;
            this.req_ingress.ring_timeout = this.ring_timer;
            this.req_ingress.max_duration = this.max_duration;
            // if(this.min_duration != '')
                this.req_ingress.min_duration = this.min_duration;
