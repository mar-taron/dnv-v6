                            ...
                            <table class="table table-striped table-hover aliases">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th v-if="showcolumns[0]" colspan="3" rowspan="1" class="text-center"><strong>ANI</strong></th>
                                        <th v-if="showcolumns[1]" colspan="3" rowspan="1" class="text-center" ><strong>DNIS</strong></th>
                                        <th v-if="showcolumns[2]" rowspan="2" colspan="1"><strong>Action</strong></th>
                                    </tr>
                                    <tr>
                                        <th v-if="showcolumns[0]" rowspan="1" colspan="1"><strong>Action</strong></th>
                                        <th v-if="showcolumns[0]" rowspan="1" colspan="1" style="text-align: center;"><strong>Match Prefix</strong></th>
                                        <th v-if="showcolumns[0]" rowspan="1" colspan="1"><strong>Replace With</strong></th>
                                        <th v-if="showcolumns[1]" rowspan="1" colspan="1"><strong>Action</strong></th>
                                        <th v-if="showcolumns[1]" rowspan="1" colspan="1"><strong>Match Prefix</strong></th>
                                        <th v-if="showcolumns[1]" rowspan="1" colspan="1"><strong>Replace With</strong></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr v-for="(list, index) in lists">
                                        ...
                                        <td v-if="showcolumns[0]">{{list.ANI_action}}</td>
                                        <td v-if="showcolumns[1]">{{list.ANI_prefix}}</td>
                                        <td v-if="showcolumns[2]">{{list.ANI_replace_to}}</td>
                                        <td v-if="showcolumns[3]">{{list.DNIS_action}}</td>
                                        <td v-if="showcolumns[4]">{{list.DNIS_prefix}}</td>
                                        <td v-if="showcolumns[5]">{{list.DNIS_replace_to}}</td>
