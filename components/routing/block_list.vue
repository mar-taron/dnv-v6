                    ...
                    <tab label="List" class="" icon="dnl_icon dnl_list" selected>
                        ...
                        <div class="advanced_search_filter_panel bottom_0">
                            <div class="inline-block">
                                <label>Ingress:</label>
                                <br>
                                <select2 :options="ingress_options" v-model="ingress">
                                </select2>
                            </div>
                            <div class="inline-block">
                                <label>Egress:</label>
                                <br>
                                <select2 :options="egress_options" v-model="egress">
                                </select2>
                            </div>
                            <div class="inline-block">
                            ...
                            <div class="inline-block medium">
                                ...
                                <br>
                                <select2 :options="blocked_by_options" v-model="blocked_by">
                                    <option disabled value="-1">Blocked by</option>
                                </select2>
                            </div>
                            <div class="inline-block">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover aliases">
                                ...
                                <tr>
                                    ...
                                    <th v-if="showcolumns[10]" rowspan="2">Updated By</th>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-4">
                                            ...
                                            <div class="button_set little-space">
                                                <a class="btn btn-primary mini" @click="exportExampleBlockListCSV">
                                                    Show Example
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select2 :options="options3" v-model="data_format"></select2>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-success">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    ...
                                    <select2 :options="block_table_columns" v-model="column_1"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #2:</label>
                                    <select2 :options="block_table_columns" v-model="column_2"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #3:</label>
                                    <select2 :options="block_table_columns"  v-model="column_3"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #4:</label>
                                    <select2 :options="block_table_columns" v-model="column_4"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #5:</label>
                                    <select2 :options="block_table_columns" v-model="column_5"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #6:</label>
                                    <select2 :options="block_table_columns" v-model="column_6"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #7:</label>
                                    <select2 :options="block_table_columns" v-model="column_7"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #8:</label>
                                    <select2 :options="block_table_columns" v-model="column_8"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #9:</label>
                                    <select2 :options="block_table_columns" v-model="column_9"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #10:</label>
                                    <select2 :options="block_table_columns" v-model="column_10"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #11:</label>
                                    <select2 :options="block_table_columns" v-model="column_11"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #12:</label>
                                    <select2 :options="block_table_columns" v-model="column_12"></select2>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group full-width-select">
                                    <label for="username">Column #13:</label>
                                    <select2 :options="block_table_columns" v-model="column_13"></select2>
                                </div>
                            </div>
...
<script>
    ...
    module.exports = {
        ...
        data: function () {
            return {
                ...
                blocked_by_options: [
                    ...
                    {id: '4', text: 'Invalid Number Detection'},
                    {id: '5', text: 'Bad ANI / DNIS Detection'},
                ...
                block_table_columns: [
                    { id: 0, text: '' },
                    { id: 1, text: 'Time Profile' },
                    { id: 2, text: 'Type' },
                    { id: 3, text: 'Egress Carrier' },
                    { id: 4, text: 'Egress Trunk' },
                    { id: 5, text: 'Ingress Carrier' },
                    { id: 6, text: 'Ingress Trunk' },
                    { id: 7, text: 'Block no ANI' },
                    { id: 8, text: 'ANI' },
                    { id: 9, text: 'DNIS' },
                    { id: 10, text: 'Blocked By' },
                    { id: 11, text: 'Updated By' },
                    { id: 12, text: 'Create Time' },
                    { id: 13, text: 'Action' },
                ],
        ...
        methods: {
            ...
            exportExampleBlockListCSV() {
                var vm = this;
                var csvContent = "data:text/csv;charset=utf-8,";
                var csvArray = new Array();
                var fields = ["Block No ANI", "ANI", "DNIS", "Egress Carrier", "egress Trunk", "Ingress Carrier", "Ingress Trunk", "Time Profile", "ANI Length Min", "ANI Length Max", "DNIS Length Min", "DNIS Length Max"];
                ...
                values.push(" ");
                values.push(" ");
                values.push("C_Airespring ");
                values.push("C_Airespring_Standard_Dialer ");
                values.push("Theresa EC2 Asterisk Switch ");
                values.push("Theresa EC2 Asterisk Switch ");
                values.push(" ");
                values.push(" ");
                values.push("32 ");
                ...
                exportToCsv('resource_block.csv', csvArray);
            },
            fetchAllTrunks (type) {
                var url;
                if(type == 'egress')
                ...
                this.$http.get(url)
                    .then(response => {
                        ...
                        if (body.success) {
                            ...
                            var self = this;
                            if(type == 'egress') {
                                this.egress_options = [{id: '0', text: 'All'}];
                                this.egress = '0';
                                trunks.forEach(function (temp, i) {
                                    var trunk = {};
                                    trunk.id = temp.resource_id;
                                    trunk.text = temp.name;
                                    self.egress_options.push(trunk);
                                });
                            }
                            else if(type == 'ingress') {
                                this.ingress_options = [{id: '0', text: 'All'}];
                                this.ingress = '0';
                                trunks.forEach(function (temp, i) {
                                    var trunk = {};
                                    trunk.id = temp.resource_id;
                                    trunk.text = temp.name;
                                    self.ingress_options.push(trunk);
                                });
                            }
                        }
                    })
            ...
            handleChange() {
                ...
                if (_.indexOf(this.block_table_columns, 'Updated By') != -1) {
