					...
					<table class="table table-striped table-hover roles carriers">
					  <thead>
						<tr>
						  ...
						  <th v-if="showcolumns[5]" class="width-98">Action</th>
						</tr>
					  </thead>
					  <tbody>
						...
						<tr v-for="carrier in filterBy(carriers, carrier_search)">
						  ...
						  <td v-if="showcolumns[5]">
							  ...
							  <a class="action action_download" data-toggle="tooltip" data-placement="top" title="Download Rate" v-on:click="download_rate(carrier.carrier_id)">
