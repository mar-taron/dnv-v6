		...
		<div class="row">
			<div class="wrapper single">
				...
				<ol class="breadcrumb">
					...
					<li v-if="!editingclient" class="breadcrumb-item active">Create New</li>
                    <li v-if="editingclient" class="breadcrumb-item active">Edit Client [{{client.carrier_name}}]</li>
				</ol>
								...
								<section class="role_section fix-select">
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
                                            ...
                                            <select class="selectable" v-model="time_zone_selected">
									...
									<div class="col-md-4 col-sm-6" v-if="client.is_show_daily_usage">
										<div class="form-group m-top-33">
											<div class="checkbox checkbox-success">
												<input id="non_zero_invoice_only" name="non_zero_invoice_only" type="checkbox">
									...
									<div class="col-md-4 col-sm-6">
                                        <div class="form-group m-top-33">
											<div class="checkbox checkbox-success">
												<input id="payment_received_alert" name="payment_received_alert" v-model="client.payment_received_alert" type="checkbox">
												<label for="payment_received_alert">Payment Received Alert</label>
											</div>
										</div>
                                    </div>
									<div class="clearfix"></div>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="small_select">
                                                ...
                                                <select class="selectable" v-model="scc_type_selected">
                                                    <option v-for="item in scc_type_options" v-bind:value="item.id">
                                                        {{ item.text }}
                                                    </option>
                                                </select>
											</div>
								...
								<section class="role_section fix-select">
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
                                            ...
                                            <select class="selectable" v-model="payment_term_selected">
                                                <option v-for="item in payment_term_options" v-bind:value="item.id">
                                                    {{ item.text }}
                                                </option>
                                            </select>
										</div>
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
                                            ...
                                            <select class="selectable" v-model="invoice_format_selected">
                                                <option v-for="item in invoice_format_options" v-bind:value="item.id">
                                                    {{ item.text }}
                                                </option>
                                            </select>
										</div>
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
											<label>Time Zone:</label>
                                            <select class="selectable" v-model="client.time_zone">
                                                <option v-for="item in time_zone_options" v-bind:value="item.id">
                                                    {{ item.text }}
                                                </option>
                                            </select>
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
                                            ...
                                            <select class="selectable" v-model="decimal_selected">
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
                                            ...
                                            <select class="selectable" v-model="rate_value_selected">
                                                <option v-for="item in rate_value_options" v-bind:value="item.id">
                                                    {{ item.text }}
                                                </option>
                                            </select>
										</div>
									...
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
											...
											<select class="selectable" v-model="client.non_zero_invoice_only">
                                                <option v-for="item in invoice_traffic_options" v-bind:value="item.id">
                                                    {{ item.text }}
                                                </option>
                                            </select>
										</div>
									...
									<div class="col-md-6 col-sm-6">
										...
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input type="checkbox" v-model="client.show_trunk_summary" name="show_total_by_trunk" id="show_total_by_trunk">
									...
									<div class="col-md-6 col-sm-6">
										...
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input type="checkbox" v-model="client.temp_show_code_name_summary" name="show_code_name_summary" id="show_code_name_summary">
										...
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input type="checkbox" v-model="client.show_code_name_summary" name="show_detail_by_code_name" id="show_detail_by_code_name">
										...
										<div class="form-group">
											<div class="checkbox checkbox-success">
												<input type="checkbox" v-model="client.is_breakdown_by_rate_table" name="break_down_by_rate_table" id="break_down_by_rate_table">
                                            ...
                                            <tbody>
                                                <tr v-for="ingress in orderBy(ingress_lists, 'carrier_name')">
                                                    ...
                                                    <td>
                                                        ...
                                                        <router-link :to="'/routing/trunks/edit/' + ingress.resource_id + '/ingress'" class="action action_edit" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <span class="dnl_icon dnl_action_edit"></span>
                                                        </router-link>
...
module.exports = {
	...
	methods: {
        ...
        resetBalance(id, balance) {
			const url = api.getEndpointUrl() + '/v1/carrier/'+ id +'/regenerate_balance'
			...
			this.$http.post(url, reqBody)
				.then(response => {
					...
					if (body.success) {
                        console.log("The balance was reseted successfully");
                        this.saveAutoInvoice();
					}
				})
				.catch(error => {
					console.log(error)
        ...
        getClientForEditRequest() {
            const client_temp = JSON.parse( JSON.stringify( this.client_temp ) )
            ...
            client_temp.daily_usage_summary = this.client.is_show_daily_usage
            ...
            if(this.client.scc_charge != null)
            ...
            client_temp.scc_type = Number(this.scc_type_selected)
		...
		getClientForCreateRequest() {
			...
			client.time_zone = this.time_zone_options[this.client.time_zone].text
			...
			if (this.payment_term_options.length) {
                let index = _.findIndex(this.payment_term_options, elem => elem.id   === this.payment_term_selected)
                console.log(index);
                if(~index)
				    client.payment_term = this.payment_term_options[index].text
            }
            ...
            // client.include_tax = this.client.include_tax;
            // client.auto_send_invoice = this.client.auto_send_invoice;
            // client.show_payment_summary = this.client.show_payment_summary;
			return client
        },
        selectTab(index) {
        ...
        getAutoInvoiceForEditRequest() {
            var auto_invoice = {}
            auto_invoice.auto_send_invoice = this.client.auto_send_invoice
            auto_invoice.show_country_summary = this.client.show_country_summary
            auto_invoice.show_account_summary = this.client.show_account_summary
            auto_invoice.show_code_summary = this.client.show_code_summary
            auto_invoice.send_invoice_as_link = this.client.send_invoice_as_link
            auto_invoice.show_detail_by_trunk = this.client.show_detail_by_trunk
            auto_invoice.show_daily_usage = this.client.show_daily_usage
            auto_invoice.show_jurisdiction_detail = this.client.show_jurisdiction_detail
            if(this.client.is_breakdown_by_rate_table != null)
                auto_invoice.is_breakdown_by_rate_table = this.client.is_breakdown_by_rate_table
            auto_invoice.show_trunk_summary = this.client.show_trunk_summary
            let index = _.findIndex(this.decimal_options, elem => elem.id   === this.decimal_selected)
            if(~index)
                auto_invoice.decimal = this.decimal_options[index].text
            index = _.findIndex(this.rate_value_options, elem => elem.id   === this.rate_value_selected)
            if(~index)
                auto_invoice.rate_value = this.rate_value_options[index].text
            if(this.client.cdr_format != null)
                auto_invoice.cdr_format = this.client.cdr_format
            index = _.findIndex(this.payment_term_options, elem => elem.id   === this.payment_term_selected)
            console.log(index);
            if(~index)
                auto_invoice.payment_term = this.payment_term_options[index].text
            auto_invoice.show_payment_summary = this.client.show_payment_summary
            if(this.client.inlcude_cdr_in_email != null)
                auto_invoice.inlcude_cdr_in_email = this.client.inlcude_cdr_in_email
            auto_invoice.include_tax = this.client.include_tax
            auto_invoice.show_code_name_summary = this.client.show_code_name_summary
            index = _.findIndex(this.invoice_format_options, elem => elem.id   === this.invoice_format_selected)
            if(~index)
                auto_invoice.format = this.invoice_format_options[index].text
            auto_invoice.non_zero_invoice_only = this.client.non_zero_invoice_only
            index = _.findIndex(this.time_zone_options, elem => elem.id   === this.client.time_zone)
            if(~index)
                auto_invoice.time_zone = this.time_zone_options[index].text
            auto_invoice.include_short_call_charge = this.client.include_short_call_charge
            return auto_invoice;
        },
        saveAutoInvoice() {
            const reqBody = this.getAutoInvoiceForEditRequest();
            console.log("reqBody: ", reqBody);
            const url = api.getEndpointUrl() + '/v1/carrier/' + this.id + '/invoices'
		...
		createNewClient() {
            ...
            if(this.editingclient) {
                ...
                this.$http.patch(url, reqBody)
                    .then(response => {
                        if (response.body.success) {
                            this.resetBalance(this.id, this.client.test_credit);
                        }
                        this.loading = false;
                    })
                    .catch(error => {
				...
				.then(response => {
					if (response.body.success) {
                        this.loading = false;
                        var client = {};
                        this.resetBalance(response.body.object_id, this.client.test_credit);
                        ...
                        setTimeout(function(){
                            ...
                            .then(result => {
                                if (result.accepted) {
                                    ...
                                    // back list page
                                    thisvm.$router.push('/management/clients/edit/'+ response.body.object_id + '/egress');
                                    thisvm.selectTab(1);
                                }
                            })
                            .catch(error => {
		...
		resetClient() {
			this.client = JSON.parse( JSON.stringify( this.emptyClient ) )
        },
        organizeInvoiceData(data) {
            console.log("organ")
            console.log(data);
            this.client.non_zero_invoice_only = data.non_zero_invoice_only;
            this.client.auto_send_invoice = data.auto_send_invoice;
            this.client.show_country_summary = data.show_country_summary;
            this.client.show_account_summary = data.show_account_summary;
            this.client.send_invoice_as_link = data.send_invoice_as_link;
            this.client.show_detail_by_trunk = data.show_detail_by_trunk;
            this.client.show_daily_usage = data.show_daily_usage;
            this.client.show_jurisdiction_detail = data.show_jurisdiction_detail;
            this.client.is_breakdown_by_rate_table = data.is_breakdown_by_rate_table;
            this.client.show_trunk_summary = data.show_trunk_summary;
            this.decimal_selected = data.decimal;
            if(data.rate_value != null) {
                let index = _.findIndex(this.rate_value_options, elem => elem.text   === data.rate_value)
                if(~index)
                    this.rate_value_selected = this.rate_value_options[index].id;
            }
            this.client.cdr_format = data.cdr_format;
            if(data.payment_term != null && data.payment_term != '') {
                let index = _.findIndex(this.payment_term_options, elem => elem.text   === data.payment_term)
                if(~index)
                    this.payment_term_selected = this.payment_term_options[index].id;
            }
            this.client.show_payment_summary = data.show_payment_summary;
            this.client.inlcude_cdr_in_email = data.inlcude_cdr_in_email;
            this.client.include_tax = data.include_tax;
            this.client.show_code_name_summary = data.show_code_name_summary;
            this.client.show_code_summary = data.show_code_summary;
            if(data.format != null) {
                let index = _.findIndex(this.invoice_format_options, elem => elem.text   === data.format)
                if(~index)
                    this.invoice_format_selected = this.invoice_format_options[index].id;
            }
            this.client.format = data.format;
            if(data.format != null) {
                let index = _.findIndex(this.time_zone_options, elem => elem.text   === data.time_zone)
                if(~index)
                    this.client.time_zone = this.time_zone_options[index].id;
            }
            this.client.include_short_call_charge = data.include_short_call_charge;
		...
		organizeClientData(data) {
			...
			this.client = {
                ...
                scc_percent: data.short_call_percent,
                scc_below: data.short_call_duration,
                scc_charge: data.short_call_charge,
			}
            this.scc_type_selected = data.short_call_charge_exceed_only;
        ...
        fetchInvoice() {
			...
			this.$http.get(url)
				.then(response => {
					const body = response.body
					if (body.success) {
						this.organizeInvoiceData(body.payload)
					}
				})
				.catch(error => {
					console.log(error)
